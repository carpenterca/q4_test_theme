...
<?php
$title = get_the_title();
$background_type = get_field('events_hero_background');
$hero_image = get_field('events_main_image');
$background_color = get_field('events_banner_background');
...
$taxonomy = 'events_archive_options';
$term_id = '11';
